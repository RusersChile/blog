---
title: 'Tutorial: Crea y publica tu propio blog con Quarto y RStudio'
...
categories:
  - tutoriales
image: featured.jpg
description: "Aprende paso a paso a crear tu propio blog con Quarto y RStudio, a personalizarlo con temas y tipografías, y publicarlo gratis en internet con GitHub Pages. Este tutorial reúne todo lo necesario para tener tu blog funcionando de principio a fin: desde configurar Git y GitHub, hasta escribir publicaciones con código de R y actualizar tu sitio cada vez que quieras."
---

> _Este tutorial es la versión en texto[^1] del [taller](https://santiagorusers.github.io/posts/taller_julio_2026/) que dictamos en vivo para el [Grupo de Usuari@s de R de Santiago](https://santiagorusers.github.io) el 29 de julio de 2026, ante más de 50 personas de toda Latinoamérica. Muchas gracias a quienes participaron!_ 

> Tutorial publicado originalmente en el [sitio web de Bastián Olea Herrera](https://bastianolea.rbind.io/blog/quarto_blog/)


## Diapositivas
<iframe width="100%" height="420" style="border-radius:6px;"
title="Diapositivas" frameborder="0"
src="https://santiagorusers.github.io/taller_quarto_blog/"></iframe>
...
> Quarto es el _sucesor_ de R Markdown: si ya conoces R Markdown, la sintaxis de Quarto te va a resultar prácticamente idéntica.
...
> Si ya usas Git y GitHub con R, puedes saltarte esta sección. Si no sabes nada de esto, puedes verlo en detalle [en esta publicación.](https://bastianolea.rbind.io/blog/r_introduccion/tutorial_github/)
...
Si quieres profundizar en Git y GitHub más allá de lo necesario para este tutorial, revisa mi [tutorial de Git y GitHub para R](https://bastianolea.rbind.io/blog/r_introduccion/tutorial_github/), o el libro [*Happy Git and GitHub for the useR*](https://happygitwithr.com).
...
El mensaje debería decirte tu cuenta de GitHub y que encontró el _token_ de acceso. Si tienes dudas o problemas, revisa [esta publicación](https://bastianolea.rbind.io/blog/r_introduccion/tutorial_github/).
...
> Si Quarto te muestra un error relacionado al *front matter* del documento, se refiere a este encabezado, así que revisa que el bloque `yaml` esté bien cerrado.

Una vez que le das **Render** a tu publicación, puedes previsualizarla en el panel *Viewer* de RStudio, o en una ventana aparte:

![](img/blog_3.png)

> Puedes configurar dónde ver la previsualización del blog en el ícono de engranaje al lado de _Render_
...
> Si necesitas aprender lo básico de Quarto y Markdown, revisa el [tutorial de reportes con Quarto.](https://bastianolea.rbind.io/blog/quarto_reportes/)


### Código de R en las publicaciones

Una de las gracias de Quarto es que puedes incluir código de R directamente en tus publicaciones, y que se ejecute al momento de generar el sitio. De esta forma puedes agregar cualquier cosa que hagas en R a tu blog: [gráficos](https://bastianolea.rbind.io/blog/r_introduccion/tutorial_visualizacion_ggplot/), [tablas personalizadas](https://bastianolea.rbind.io/blog/tablas_gt), [mapas interactivos](https://bastianolea.rbind.io/blog/mapas_mapgl/), y más.
...
> Te recomiendo dejar configurado el tema y el menú de tu sitio **antes** de empezar a escribir publicaciones, para que todas las publicaciones que crees después hereden automáticamente esa apariencia.
...
```
> Puedes buscar paletas de colores y sus códigos hexadecimales en sitios como [coolors.co](https://coolors.co/palettes).
...
> Estos conocimientos esotéricos sobre CSS son muy útiles para el [web scraping](https://bastianolea.rbind.io/tags/web-scraping/)!
...
Con el sitio preparado y [GitHub configurado](https://bastianolea.rbind.io/blog/quarto_blog/#configurar-git-y-github), ahora creamos el repositorio local y lo subimos a GitHub:
...
> Si renombras tu repositorio a `tu_usuario.github.io`, tu sitio quedará disponible directamente en `https://tu_usuario.github.io`, sin el nombre del repositorio al final.
...
#### Tutoriales
- [Crea un repositorio Git y comparte tu código en GitHub](https://bastianolea.rbind.io/blog/r_introduccion/tutorial_github/)
- [Reportes y documentos con Quarto](https://bastianolea.rbind.io/blog/quarto_reportes/)
- [Crea páginas web y blogs con R + Quarto](https://bastianolea.rbind.io/blog/tutorial_quarto_github_pages/)
...
[^1]: _Disclaimer:_ este tutorial se escribió con apoyo del asistente de IA [Posit Assistant](https://bastianolea.rbind.io/blog/posit_assistant/). Para más información sobre la forma en que fue redactado en base a las transcripciones de voz, diapositivas y otros recursos, [leer este post.](https://bastianolea.rbind.io/blog/2026-08-08/)